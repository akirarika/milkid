...
export function __secureRandomBigInt(min: bigint, max: bigint): bigint {
...
export function __bigIntToString(value: bigint): string {
...
export function __stringToBigInt(str: string): bigint {
...
export function __getMaxValue(n: bigint): bigint {
